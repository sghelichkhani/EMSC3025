...
.footer
    Tutorial 2: Precipitation

#! Tutorial 2: Precipitation

###! 1. *The build-up season in the Top End*
...
###! 3. Sierra Nevada Transect

*Figure A* shows a west-to-east cross-section across California’s Sierra Nevada from the Pacific coast to Owens Valley. On your copy of the figure, mark:
- i. the zone of **maximum orographic precipitation**;
- ii. the **rain-shadow region**.
...
b. Annotate approximate temperature changes (°C) of a rising unsaturated parcel that moves:
  1. sea-level to 3 000 m; 2. crest to Owens Valley floor.
  (Use the dry- and saturated-adiabatic lapse rates as appropriate.)

c. Name **two rain-shadow communities** east of the crest and discuss, in  $ \approx 100 $ words, how this precipitation pattern shapes their water-supply strategies.


###! 4. Paired Forest-Pasture Experiment  *(fully hypothetical)*
...
- Draw a **paired bar chart** comparing daily rainfall at the two gauges.
