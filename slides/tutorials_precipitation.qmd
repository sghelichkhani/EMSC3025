...
- Annotate approximate temperature changes (°C) of a rising unsaturated parcel that moves:
    - sea-level to 3 000 m; 2. crest to Owens Valley floor. (Use the dry- and saturated-adiabatic lapse rates as appropriate.)
    - Name **two rain-shadow communities** east of the crest and discuss, in  $ \approx 100 $ words, how this precipitation pattern shapes their water-supply strategies.
