...
- Alternatively, use modern formulations like **Penman**, which incorporate:
  - Net radiation (available energy)
  - Vapour pressure deficit ($ delta_e = e_s - e_a $)
...
If actual observations show $ E_t/E_{pt} \approx 1 $ on most days, the assumption is valid for that season. The non-linear relationship shown on [this figure](https://water-course.github.io/content/Evaporation/index.html#/28) is how one can relate actual evaporation to potential evaporation.
...
$ I = 0.21 + 3.56 + 7.92 + 7.68 + 8.90 + 2.32 + 0.89 = 31.12 $

**Step 2: Calculate the exponent $ a $**
Using the cubic polynomial:

$ a = 0.492 + 0.01179 \cdot I - 0.0000771 \cdot I^2 + 0.000000675 \cdot I^3 $
$ a = 0.492 + 0.3709 - 0.0764 + 0.0000215 = 0.81 $

**Step 3: Compute unadjusted monthly $ E_{pt} $**
$ E_{pt} = 1.62 \left( \dfrac{10 T_a}{I} \right)^a $

From Table, the unadjusted $ E_{pt} $ values (cm) for May to September are:
...
- May: $ 4.69 \times 1.33 = 6.23 $
- June: $ 7.19 \times 1.36 = 9.57 $
- July: $ 7.07 \times 1.37 = 9.69 $
- August: $ 7.66 \times 1.25 = 9.58 $
- September: $ 3.71 \times 1.06 = 3.94 $$ E_{pt} $

<<<

.code lang:{python}
  .read{python_001_evaporation.py}
