...
.row gap:{1cm} alignment:{center}
  .container width:{60%} alignment:{center} borderwidth:{1pt} padding:{0.5cm} radius:{0.5cm} background:{.lightblue}
...
.row gap:{1cm}
  .container width:{60%}
    .align{center}
         ...
         "Comparison of two Pine Radiata Forests in New Zealand (Kelliher and Jackson, 2001)"
...
.row gap:{1cm}
    .container width:{60%} borderwidth:{1pt} padding:{0.5cm} radius:{0.5cm} background:{.lightblue}
        ...
        $ B = \frac{\gamma \cdot \Delta T}{\Delta e} $
...
.row
  ...
  .container width:{50%}
    .mermaid
      flowchart LR
        A[Surrogate Methods] --> B[Thornthwaite]
        A[Surrogate Methods] --> C[Penman]
        A[Surrogate Methods] --> D[Penman-Monteith]
...
.row gap:{1cm}
  ...
  .container width:{50%} borderwidth:{1pt} padding:{0.5cm} radius:{0.5cm} background:{.lightblue}
    ...
    $ a = 6.75 \times 10^{-7} I^3 - 7.7 \times 10^{-5} I^2 + 0.018 I + 0.49 $
...
- Combination of .ul{energy balance} and .ul{vapour pressure deficit}.
...
with $ Q^* $ the net radiation, $ \delta_e $ the vapour pressure deficit, and $ u $ the wind speed at 2 m elevation, $ \Delta $ is the rate of increase of the saturation vapour deficit with temperature, $ \gamma $ is the psychrometric constant (0.063 kPa / °C).

Requires observations of .ul{temperature}, .ul{wind speed}, .ul{vapour pressure} and .ul{net radiation}, and provides the rate of evaporation in mm / day. Ignores soil heat flux, and that the vapour pressure deficit is the only limiting factor.
...
.row gap:{1cm}
  .container width:{50%} borderwidth:{1pt} padding:{0.5cm} radius:{0.5cm} background:{.lightblue}
    ...
    $ PE = \alpha \frac{\Delta (Q^* - Q_G)}{\Delta + \gamma} $
...
.row gap:{1cm}
  ...
  .container width:{50%}
    ![Soil moisture](image/davie_3rd_3-10.png "Relationship between actual and potential evaporation")
...
.row gap:{1cm}
  ...
  .container width:{50%}
    ![Soil moisture](image/davie_3rd_fig_3-11.png "Relationship between actual and potential evaporation")
