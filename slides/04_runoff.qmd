...
.row gap:{1cm}
    ...
    .container width:{50%} radius:{0.5cm} borderwidth:{0.5pt} background:{.lightblue}
...
.fullspan
    !(70%)[Catchment](image/davie_3rd_fig_7-2.png "Comparative hydrographs for two adjacent sub-catchments in the Thames catchment.")

    .fragment content:{ Identical climatic conditions, but different geology. Rocks of the Lambourn are all high permeability, while the Thames catchment is mostly low permeability + bedrock.}
...
.row gap:{1cm}
    .container width:{50%}
        ...
        .fragment content:{Continuous sheets of overland water flow are rarely observed in nature.}
    ...
    .container width:{50%}
        ...
        - .fragment content:{.ul{However}, in most cases, infiltration rates exceed typical rainfall intensities.}
