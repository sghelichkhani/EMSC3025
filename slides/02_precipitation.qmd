...
.row
    ...
    .container width:{27%}
        !(100%)[Text](image/davie_fig_2-6-a.png "Fourteenth-centruing rain gauge from Korea.")
    .container width:{30%}
...
.fullspan
    .mermaid
        flowchart TB
            ...
            A([Rainfall Measurement Errors]) --> E([Turbulance])
...
.row gap:{1cm}
    ...
    .container width:{40%} height:{100%}
        !(100%)[Turbulant flow](image/davie_fig_2-8.png "Top: Turbulent flow over a raised gauge (eddies and drop deflection). Bottom: Baffles surrounding a rain gauge to lessen the impact of wind. Wind shield ")

        !(100%)[Turbulant flow](image/davie_fig_2-9.png)
...
.row
  .container width:{50%}
    .box title:{How to optimse?} background:{.lightred}
...
.fullspan
     !(60%)[Text](image/davie_fig_4-12.png "Snow pillow technique.")
...
# Summary:
.box title:{Precipitation: Formation, Measurement, and Spatial Estimation}
