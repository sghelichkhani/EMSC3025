...
.row gap:{1cm} alignment:{center}
  .container width:{60%} borderwidth:{1px} padding:{0.5cm} radius:{0.1cm} background:{.lightblue}
    - I am an Earth scientist with a strong interest in fluid dynamics and numerical modeling.
    ...
    - These processes include groundwater flow, glacio-isostatic adjustment of the Earth's surface, and mantle convection—each of which can be described as fluid dynamics under the right conditions.
