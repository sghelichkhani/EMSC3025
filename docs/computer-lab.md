...
- [Tutorial 1 - Precipitation](computer-lab/Ex1_Precipitation_solution.ipynb): Apply multiple interpolation methods to estimate missing rainfall values, using real storm data and geospatial coordinates — adapted from a tutorial by [Jesús Casado Rodríguez](https://github.com/casadoj).
